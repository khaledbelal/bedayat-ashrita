<div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion">
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main"> 
      ...
      <li class="nav-item"><a href="{{ route('cpanel-sheikhs') }}"><i class="ft-users"></i><span data-i18n="" class="menu-title">عرض الشيوخ</span></a> </li>  
      <li class=" nav-item"><a href="{{ route('cpanel-add-sheikh') }}"><i class="ft-user-plus"></i><span data-i18n="" class="menu-title">اضافة شيخ</span></a> </li>  
      <li class=" navigation-header"><span>المقدمات</span><i data-toggle="tooltip" data-placement="right" data-original-title="General" class=" ft-minus"></i>
          </li>
